...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "A Hindi-language Android app serving as a digital church library and worship companion." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/4nh01HXxQAhVOtX2WoD9BwamItV2/social-images/social-1782457063060-1000552170.webp" },
